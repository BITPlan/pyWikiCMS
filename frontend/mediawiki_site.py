...
class MediaWikiSite:
    ...
    def __init__(self, wiki_user:WikiUser,row_index:int=0,debug:bool=False,show_html:bool=False):
        """
        constructor
        """
    ...
    def check_version_via_url(self) -> str:
        ...
        mw_version = "?"
        try:
            html_tables = HtmlTables(version_url,debug=self.debug,showHtml=self.show_html)
